...
<main>
    <style>
        ...
        .album{
            background-image: url('/storage/app/public/FondoMadera.jpg');
    ...
    <div class="album py-5 bg-danger" style="background-image: url('{{ asset('images/biblioteca.jpg') }}'); background-size: cover; background-position: center;">
        <div class="container">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <p> 
                                        ...
                                        <i class="bi bi-chat-dots"></i> {{count($foto->comentario)}}
                                        </button>
                                    </p>
                                </div>
                                ...
                                @csrf
                                    <div class="form-group">
                                        <div class="mt-2 row g-3">
                                            <div class="col-9">
                                                <input type="text" class="form-control" name="comentario" aria-describedby="emailHelp" placeholder="Responder">
                                            </div>
                                            <div class="col-2">
